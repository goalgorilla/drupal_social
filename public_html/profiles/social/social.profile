...
function social_form_install_configure_form_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['social']['features'] = [
    ...
    '#default_value' => ['social_core', 'social_devel', 'social_editor', 'social_event', 'social_explore', 'social_topic', 'social_group', 'social_user', 'social_comment', 'social_search', 'social_post', 'social_profile'],
  ];
